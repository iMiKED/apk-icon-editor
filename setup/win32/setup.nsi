...
!define VERSIONDISPLAY "${VERSION}-beta5"
...
Section "-un.Uninstall"
	...
	Delete "$INSTDIR\icon-size-presets.json"
	...
	Delete "$INSTDIR\gfx\devices\amazon.png"
	Delete "$INSTDIR\gfx\devices\android.png"
	Delete "$INSTDIR\gfx\devices\blackberry.png"
